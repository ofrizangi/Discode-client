...
function NumberArgument(props) {
    ...
    const [val, setVal] = useState(row.arguments[index] === null ? "" : row.arguments[index] )
    ...
    return (
        <span>
            ...
            <input id={Constants.ARGUMENTS_IDENTIFIER} type="number" className="number" value={ val} onChange={set_argument}/>
        </span>
    );

...
import { get_game_blocks, swap_command_api, post_command, delete_command_api, post_inner_command, 
...
function BlocksPage(props) {
    ...
    */
    ...
    async function add_new_command(src_index ,dest_index){
        const id = src_index.toString() + dest_index.toString()
    ...
    async function add_new_inner_command(outer_command_index , src_index , dest_index){
        ...
        console.log("com" , solution, commands)
    ...
    return (
        <div>
            ...
            <div className="row d-none d-md-flex">
                <div className="col-6"> <BlockList blocks={blocks} commands={commands} max_number_of_rows={props.max_number_of_rows}/> </div>
